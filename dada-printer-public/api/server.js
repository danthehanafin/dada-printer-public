// This is a native Vercel Serverless Function, which is more robust than using Express.
...
module.exports = async (req, res) => {
  // Manually set the CORS headers for every request. This is the most reliable method.
  ...
  // we send an immediate "OK" response and stop.
